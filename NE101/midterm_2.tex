...
of valence neutrons. Around 4, you see collective motion.~\cite[Lec. 13-16]{lecture}
\end{itemize}

\subsection{Vibration}
\begin{itemize}
\item A vibration can move over the surface of the nucleus. The order
  of this vibration is given by lambda ($\lambda$).
...
spin $S=1$ lined up with the angular momentum.
\end{itemize}

\begin{itemize}
\item \item Helicity: helicity is just a property that we define based
